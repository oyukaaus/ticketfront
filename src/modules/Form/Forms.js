                                        ...
                                        >
                                            ...
                                            />
                                            {
                                                field?.fileType == 'image'
                                                    ?
                                                    <img src={field?.files && field?.fileData ? field?.fileData ? URL?.createObjectURL(field?.fileData) : field?.altImage : field?.altImage} width='100' alt={field?.fileNames || 'empty'} />
                                                    :
                                                    field.fileNames
                                            }
                                            <br />
