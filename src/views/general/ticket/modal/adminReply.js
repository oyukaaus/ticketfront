...
import { adminReply } from 'utils/fetchRequest/Urls';
...
const ReplyAdmin = ({
    ...
    const [selectedStatus, setStatus] = useState(statusId || '');
    ...
    const onSaveClick = () => {
        ...
        fetchRequest(adminReply, 'POST', postData)
            .then((res) => {
                        ...
                        <Row className='gx-0'>
                            <Col className='pe-2'>
                                <Select
                                    ...
                                    required
                                    className={statusErrorMsg ? 'fs-14 is-invalid' : 'fs-14'}
                                    onChange={onChangeStatus}
                                />   {
                                    statusErrorMsg ?
                                        <div className='invalid-feedback d-block'>
                                            {t('errorMessage.statusErrorMsg')}
                                        </div>
                                        :
                                        null
                                }
