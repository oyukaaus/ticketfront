...
const index = () => {
    ...
    const breadcrumbs = [
        { to: '', text: t('menu.home') },
        { to: 'education/integrated-group', text: t('departmentOfEducation.integratedGroup') },
    ];
    ...
    const column = [
        {
            ...
            formatter: (cell) => {
                return <i className={`icon-1_5x ${cell ? 'custom-green' : 'main-gray'} fa fa-circle fs-10`} />
            }
        },
        {
            dataField: 'grade',
            text: t('departmentOfEducation.grade'),
            sort: true,
        },
        {
            dataField: 'subject',
            text: t('departmentOfEducation.subject'),
            sort: true,
        },
        {
            dataField: 'groupName',
            text: t('departmentOfEducation.groupName'),
            sort: true,
        },
        {
            dataField: 'studentCount',
            text: t('departmentOfEducation.students'),
            sort: true,
        },
        {
            dataField: 'startDate.date',
            text: t('departmentOfEducation.startDate'),
            sort: true,
        },
        {
            dataField: 'endDate.date',
            text: t('departmentOfEducation.endDate'),
            sort: true,
        },
    ];
            ...
            <Row>
                <Col lg={12} className="mb-3">
                    <h2 className='font-standard mb-0'>
                        {t('departmentOfEducation.integratedGroup')}
                    </h2>
                    <BreadcrumbList
                        basePath='/'
                        key={1}
